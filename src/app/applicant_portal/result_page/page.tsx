              ...
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div className="border rounded-2xl p-4 hover:border-blue-300 dark:hover:border-blue-500 hover:shadow-lg transition">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white rounded-xl flex items-center justify-center gap-2 text-sm sm:text-base transition"
                  >
                ...
                <div className="border rounded-2xl p-4 hover:border-green-300 dark:hover:border-green-500 hover:shadow-lg transition">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white rounded-xl flex items-center justify-center gap-2 text-sm sm:text-base transition"
                  >
